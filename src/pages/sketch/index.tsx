...
import { GithubOutlined, WechatOutlined, QqOutlined, MailOutlined } from '@ant-design/icons';
...
const contactShowList: ContactShowType[] = [
  { icon: <GithubOutlined className='icon' />, url: 'https://github.com/ttlive12' },
  { icon: <WechatOutlined className='icon' />, copy: 'lwqykst' },
  { icon: <QqOutlined className='icon' />, url: 'https://qm.qq.com/q/VLsW91rOM0' },
  { icon: <MailOutlined className='icon' />, copy: 'lwqykst@yeah.net' }
]
const Sketch: React.FC = () => {
  return <div className="sketch-container">
